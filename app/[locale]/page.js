import { ArrowRight, Code2, Palette, Rocket, Zap, CheckCircle2, Globe } from "lucide-react"
...
export default function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Hero Section */}
      <section className="relative max-sm:pt-20 pt-32 pb-20 px-4 overflow-hidden">
        {/* Background gradient orbs */}
        <div className="absolute top-20 left-10 w-96 h-96 bg-accent/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-10 w-96 h-96 bg-chart-1/20 rounded-full blur-3xl" />

        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block mb-6 px-4 py-2 ">
              <div className="md:hidden"><Image src={'/white-logo.png'} height={90} width={90} alt="logo" /></div>
            </div>

            <h1 className="text-5xl md:text-7xl font-bold mb-6 text-balance leading-tight font-[Gambarino]">
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto text-pretty leading-relaxed">
              Transform your vision into a powerful digital presence. We create fast, secure, and scalable websites that
      ...
      <section className="py-16 px-4 border-y border-border bg-primary">
        <div className="container mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2 text-white">5x</div>
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-balance">Everything you need to succeed online</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="group p-8 bg-card border border-border rounded-2xl hover:border-accent/50 transition-all duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Tailored solutions built with modern technologies like Next.js, React, and TypeScript for optimal
                performance.
              </p>
            </div>
            ...
            <div className="group p-8 bg-card border border-border rounded-2xl hover:border-accent/50 transition-all duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Beautiful, intuitive interfaces that engage users and convert visitors into customers.
              </p>
            </div>
            ...
            <div className="group p-8 bg-card border border-border rounded-2xl hover:border-accent/50 transition-all duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Quick turnaround times with automated CI/CD pipelines and seamless hosting on Vercel.
              </p>
            </div>
            ...
            <div className="group p-8 bg-card border border-border rounded-2xl hover:border-accent/50 transition-all duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Lightning-fast websites optimized for SEO, Core Web Vitals, and exceptional user experience.
              </p>
            </div>
            ...
            <div className="group p-8 bg-card border border-border rounded-2xl hover:border-accent/50 transition-all duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Complete online stores with secure payments, inventory management, and analytics integration.
              </p>
            </div>
            ...
            <div className="group p-8 bg-card border border-border rounded-2xl hover:border-accent/50 transition-all duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Continuous maintenance, updates, and technical support to keep your site running smoothly.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-4 bg-card/50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-balance">Trusted by businesses worldwide</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
              We've helped companies of all sizes achieve their digital goals with stunning, high-performance websites.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-secondary border border-border aspect-[4/3] hover:border-accent/50 transition-all duration-300">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-6">
                  <div className="text-6xl font-bold mb-2 opacity-50">E-commerce</div>
                  <div className="text-muted-foreground">Fashion Retail Platform</div>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-secondary border border-border aspect-[4/3] hover:border-accent/50 transition-all duration-300">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-6">
                  ...
                  <div className="text-muted-foreground">Project Management Tool</div>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-secondary border border-border aspect-[4/3] hover:border-accent/50 transition-all duration-300">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-6">
                  <div className="text-6xl font-bold mb-2 opacity-50">Corporate</div>
                  <div className="text-muted-foreground">Financial Services Site</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl md:text-6xl font-bold mb-6 text-balance">Ready to transform your business?</h2>
